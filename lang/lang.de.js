texts = [
    ...
    "kontakt",
    "Hallo",
    "Ich bin Johannes Pirlet",
    "Frontend Developer",
    "über mich",
    "Hier nur mal ein kurzer Abriss meiner Fähigkeiten im Umgang mit WebTechnologien und Erfahrungen im Bereich der Frontend Programmierung.",
    "Hey,",
    "ich bin auf der Suche nach Frontendprojekten, die im Hinblick auf userspezifische Anforderungen und erlebnisreichen Ergebnissen entwickelt werden. Dabei möchte ich jeden professionellen Einfluss nutzen, um an einem zugänglichen und performanten Gesamtprodukt mitzuwirken.",
    "Selbsternannte Schwerpunkte und Vorlieben meiner Arbeit orientieren sich an Single Page Applikationen und komponentenbasierten Frameworks. Dabei stehen Grundsätze von Accessibility und responsiver Gestaltung im Vordergrund. Außerdem sind Begriffe aus dem UX/UI Design für mich keine reinen Schlagwörter, sondern ergänzen mein Verständnis moderner Webprodukte.",
    "Daher freue ich mich über Arbeitsangebote, an denen ich mitwirken, lernen und wachsen kann. Falls ich Ihr Interesse geweckt habe, schauen Sie sich meine Projekte an und senden Sie mir gerne eine Nachricht!",
    "Kontakt",
    "Lebenslauf",
    "Mein TechStack",
    "projekte",
    ...
    "Fallstudie",
    `Effizient mit "Flow"`,
    "React - MongoDB - Node.js - Rest API - Bootstrap",
    "Projektmanagement Tool nach dem Kanban Vorbild. Erstelle und strukturiere Aufgaben durch Zuweisung von Personen, Deadlines und Kategorien.",
    "kontakt",
...
ariaLabels = [
    "mein persöhnliches Logo das beim Klick die Seite neu lädt",
    "Sprachauswahl",
    "Hauptmenü",
...
alts = [
    ...
    "Bildschirmfoto von der Website Flow. Ein Dashboard mit einem Kanban Board",
    "Verbinde dich auf Xing mit mir",
    "Folge mir auf Github",
    "Schick mir eine Email",
