texts = [
    ...
    "Case Study",
    `Stay agile with "Flow"`,
    "React - MongoDB - Node.js - Rest API - Bootstrap",
    "Task Manager inspired by the Kanban System. Create and organize tasks by assigning them to users and categories.",
    "contact",
...
alts = [
    ...
    "Screenshot of the website called Flow. A dashboard with a kanban board mockup.",
    "Connect with me on Xing",
    "Like Me on Facebook",
    "Send me an E-Mail",
